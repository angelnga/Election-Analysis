...
with open (file_to_load) as election_data:
    ...
    for row in file_reader:
        ...
        # 3b. Add a vote to that candidate's count.
...
with open(file_to_save, "w") as txt_file:
    ...
    for candidate_name in candidate_votes:
        ...
        # 4e. To do: print out each candidate's name, vote count, and percentage of
        ...
        # 4f. Determine winning vote count and candidate
    ...
    #  4g. To do: print out the winning candidate, vote count and percentage to
    #   terminal.
